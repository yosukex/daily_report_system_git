    ...
    <c:param name="content">
        <c:choose>
            <c:when test="${employee != null}">
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${employee.admin_flag == 1}"><p>管理者</p></c:when>
                                    <c:otherwise><p>一般</p></c:otherwise>
                                </c:choose>
                            </td>
                        </tr>
                        <tr>
                ...
                <p><a href="${pageContext.request.contextPath}/employees/edit?id=${employee.id}">この従業員情報を編集する</a></p>
